...
Histological type of breast cancer (ductal or lobular).

**Cellularity**  
How densely packed the tumor cells appear.

**ER / PR Status**  
Estrogen and Progesterone receptor status.

**HER2 Status**  
Protein affecting cancer growth.
...
**Tumor Stage**  
Overall extent of cancer spread.
""")
